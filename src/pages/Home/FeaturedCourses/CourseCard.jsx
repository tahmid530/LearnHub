...
const levelColors = {
  Beginner: "bg-lime-600/20 text-lime-600",
...
export default function CourseCard({ course }) {
  return (
    ...
    >
      <GlassCard className="group overflow-hidden hover:shadow-[0_0_40px_rgba(99,102,241,0.18)]">
        ...
        <div className="relative overflow-hidden">
          ...
          <span
            className={`absolute left-4 top-4 rounded-full px-3 py-1 text-xs font-semibold ${badgeColors[course.badge]}`}
          >
            {course.badge}
          </span>
          ...
          <span
            className={`absolute right-4 top-4 rounded-full px-3 py-1 text-xs font-medium ${levelColors[course.level]}`}
          >
            {course.level}
          </span>
        ...
        <div className="p-6">
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <Button
              size="sm"
              className="bg-indigo-600 hover:bg-indigo-500 border-0 shadow-none"
            >
              Enroll
            </Button>
